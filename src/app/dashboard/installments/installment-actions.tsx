...
export default function InstallmentActions({ id, status, amount, dueDate }: { id: string, status: string, amount: number, dueDate: string }) {
    ...
    return (
        <div className="flex items-center gap-2">
            ...
            <EditInstallmentDialog id={id} currentAmount={amount} currentDueDate={dueDate} />
        </div>
    )
}
